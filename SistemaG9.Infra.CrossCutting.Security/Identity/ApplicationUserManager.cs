...
namespace SistemaG9.Infra.CrossCutting.Security.Identity
{
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
            ...
            : base(store)
        {
            ...
            var provider = new DpapiDataProtectionProvider("José Carvalho");
            var dataProtector = provider.Create("JCarvalho TI");
